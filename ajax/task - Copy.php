...
if (hasIdParam()) {
   ...
   if (isset($editedTask->task) && isset($editedTask->task->id)) {
      ...
      if($editedTask->status =='CLOSED' || $editedTask->status=='CANCELLED') $disabled =true;
               ...
               <form class="smart-form" id="task_form" method="post">
                  ...
                  <?php if ($isUpdate) { ?>
                     ...
                     <input type="hidden" id="createDate" data-name="<?= $editedTask->createDate ?>" data-value="<?= $editedTask->createDate ?>">
                      ...
                      <input type="hidden" id="depot_id" data-value="<?= $editedTask->depot_id ?>" data-name="<?= $editedTask->depot_id ?>">
                      <input type="hidden" id="container_type_id" data-value="<?= $editedTask->container_type_id ?>" data-name="<?= $editedTask->container_type_id ?>">
                      <input type="hidden" id="mile" data-value="<?= $editedTask->mile ?>" data-name="<?= $editedTask->mile ?>">
                      <input type="hidden" id="qty" data-value="<?= $editedTask->qty ?>" data-name="<?= $editedTask->qty ?>">
                  ...
                  <fieldset>
                     ...
                     <div class="row order-class">
                         <section class="col col-6">
                             ...
                             <select class="field-disabled" name="assign_order" id="assign_order" style="width:100%;"></select>
                         </section>
                         <section class="col col-6">
                             <label class="label">Product(*)</label>
                             <label class="input">
                                 <select id="product_sku" class="valid h32 field-disabled" style="width:100%" disabled=""></select>
                             </label>
                         </section>
                     </div>
...
<?php if ($isUpdate) {  ?>
    <script type="text/javascript">
         product_sku_eidt = '<?php echo $editedTask->product_sku;?>';
    </script>
<?php } ?>
